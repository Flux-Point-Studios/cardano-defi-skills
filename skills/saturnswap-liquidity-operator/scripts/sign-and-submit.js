...
import { submitLiquidityTransaction } from "../../../scripts/saturnswap-client.js";
...
// Step 1: Sign
console.log(`Signing liquidity transaction ${txId}...`);
let signedHex;
try {
...
// Step 2: Submit
console.log(`Submitting liquidity transaction ${txId}...`);
const data = await submitLiquidityTransaction(address, [txId], [signedHex]);
const result = data.submitLiquidityTransaction;
